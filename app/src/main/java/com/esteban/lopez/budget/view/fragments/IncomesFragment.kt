...
class IncomesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.textView6.setText(R.string.incomes)


        lifecycleScope.launchWhenResumed {
            incomeViewModel.getIncomesAndCategory().collect {
            ...
            object : ValuesAdapter.OnItemClickListener {
                override fun onClick(item: ValueAndCategory) {
                    findNavController().navigate(
                        IncomesFragmentDirections.actionIncomesFragmentToEditValueFragment(
                            item.value.id!!,
